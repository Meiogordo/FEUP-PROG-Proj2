...
void BusManager::displayLines() {
	for (int i = 0; i < lines.size(); i++) {
		cout << "ID: " << lines[i].ID << " Primeira e �ltima paragem: ";
...
bool BusManager::Load() {
	...
	cout << "(Ctrl+Z para abortar o processo - a informa��o interna estar� vazia e a maior parte das funcionalidades n�o ir�o funcionar corretamente)"	cout << ">> ";
	...
	if (cin.eof()) {
		cin.clear();
		cin.ignore(10000, '\n');
		cout << "EOF detetado, abortando processo de cria��o de gestor de empresa de autocarros..." << en		return false;
	}
