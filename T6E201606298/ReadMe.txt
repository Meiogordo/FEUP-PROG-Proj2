...
- O programa é totalmente cross-platform;
- Existe suporte para input e output de carateres de todo o alfabeto latino, incluindo carateres especiais como 'ç' ou 'ã', em windows, e suporte para output de carateres em Linux (talvez input também funcione mas como não uso Linux nem qualquer tipo de sistema Unix não pude testar isto).
